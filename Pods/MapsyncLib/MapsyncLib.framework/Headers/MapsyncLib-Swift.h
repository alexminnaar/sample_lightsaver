// Generated by Apple Swift version 4.1 effective-3.3 (swiftlang-902.0.34 clang-902.0.30)
...
@property (nonatomic, readonly, copy) NSString * _Nonnull developerKey;
- (nullable instancetype)initWithArSession:(ARSession * _Nonnull)arSession mapsyncMode:(enum MapsyncMode)mapsyncMode userID:(NSString * _Nonnull)userID mapID:(NSString * _Nonnull)mapID developerKey:(NSString * _Nonnull)developerKey error:(NSError * _Nullable * _Nullable)error statusCallback:(void (^ _Nonnull)(enum MapsyncStatus))statusCallback OBJC_DESIGNATED_INITIALIZER;
